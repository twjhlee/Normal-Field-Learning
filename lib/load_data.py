...
from .load_omniblender import load_omniblender_data
from .load_egocentric import load_egocentric_data
from .load_clearpose import load_clearpose_data
from .load_inmc import load_inmc_data
...
def load_data(args):
    ...
    if args.dataset_type == 'llff':
        ...
        near, far = args.near_far
        print('NEAR FAR', near, far)

    elif args.dataset_type == 'blender':
        images, poses, render_poses, hwf, i_split = load_blender_data(args.datadir, args.half_res, args.testskip, args.bg_color, args.use_mask, args.train_step)
        ...
        images, poses, render_poses, hwf, i_train, i_test = load_omniblender_data(basedir=args.datadir)
        i_val = i_test

        near, far = args.near_far
    
    elif args.dataset_type == 'egocentric':
        images, poses, render_poses, hwf, i_train, i_test = load_egocentric_data(basedir=args.datadir)
        i_val = i_test

        near, far = args.near_far

    # elif args.dataset_type == 'clearpose':
    #     images, poses, render_poses, hwf, i_split = load_clearpose_data(
    #         args.datadir,
    #         imgdir=args.imgdir,
    #         datatype=args.datatype,
    #         use_depthmask=args.use_depthmask,
    ...
    #     # near_clip, far = inward_nearfar_heuristic(poses[i_train, :3, 3], ratio=0.02)
    #     # far = 15.0
    #     near_clip, far = args.near_far
    #     near = near_clip
    #     cx, cy = 334, 248
    elif args.dataset_type == 'inmc':
        images, poses, render_poses, hwf, K, i_split = load_inmc_data(
            args.datadir,
            imgdir=args.imgdir,
            datatype=args.datatype,
            use_depthmask=args.use_depthmask,
        ...
        print('Loaded inmc', images.shape, hwf, args.datadir)
        i_train, i_val, i_test = i_split
        near, far = args.near_far

    elif args.dataset_type == 'clearpose':
        images, poses, render_poses, hwf, K, i_split = load_clearpose_data(
            args.datadir,
            imgdir=args.imgdir,
            datatype=args.datatype,
            use_depthmask=args.use_depthmask,
