...
from data.dataloader_finetune import get_loaders
...
def train(model, args, device):
    ...
    # dataloader - finetune
    # train_loader = FinetuneLoader(args, 'train').data
    # test_loader = FinetuneLoader(args, 'test').data
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = NNET(args)
    checkpoint = './checkpoints/%s.pt' % args.dataset_name
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset_dir", default="/home/twjhlee/Data/RGB2Normal/clearpose_new/train")
    ...
    parser.add_argument("--data_augmentation_random_crop", default=True, action="store_true")
